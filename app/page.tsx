...
export default function LandingPage() {
  ...
  return (
    <>
      ...
      <PageWrapper>
        <HeroSection>
          <div className="grid gap-8 lg:grid-cols-2 lg:gap-12 xl:gap-16 items-center mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <motion.div
            ...
            >
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="max-w-[600px] text-base text-gray-500 sm:text-lg md:text-xl">
                  ...
                  cash payments with automatic thermal printing.
                </p>
              </div>
          ...
          <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-4xl text-center">
              ...
              <p className="mt-3 text-gray-500 sm:mt-4">
                DineEasy simplifies restaurant operations in just three easy
                steps
              </p>
            </div>
              ...
              {[
                {
                  ...
                  title: "Scan QR Code",
                  description:
                    "Customers scan a unique QR code at their table to access your digital menu instantly",
                },
                {
                  icon: (
                    <Timer className="h-8 w-8 text-green-600 sm:h-10 sm:w-10" />
                  ),
                  title: "Place Orders",
                  description:
                    "Orders are sent directly to your real-time dashboard and auto-printed on thermal printers",
                },
                {
                  icon: (
                    <Smartphone className="h-8 w-8 text-green-600 sm:h-10 sm:w-10" />
                  ),
                  title: "Pay Seamlessly",
                  description:
                    "Customers pay via Stripe, TWINT, or cash with funds going directly to your account",
                },
              ].map((step, index) => (
              ...
              {[
                {
                  ...
                  description:
                    "Digital menus with AI OCR upload and real-time updates",
                },
                {
                  title: "Multi-Payment Support",
                  description:
                    "Accept Stripe, TWINT, and cash payments seamlessly",
                },
                {
                ...
                },
                {
                  ...
                  description:
                    "Live order tracking and analytics for your team",
                },
              ].map((feature, index) => (
                <FeatureCard
                  key={index}
          ...
          <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <AnimatedSection>
              <div className="mx-auto max-w-4xl text-center">
                ...
                <p className="mt-3 text-gray-500 sm:mt-4">
                  See what restaurant owners are saying about DineEasy
                </p>
              </div>
            </AnimatedSection>
            <div className="mt-12 grid gap-8 sm:mt-16 sm:grid-cols-2 lg:grid-cols-3">
              {[
                ...
                >
                  ...
                  <blockquote className="mb-3 text-sm sm:mb-4 sm:text-base">
                    "{testimonial.quote}"
                  </blockquote>
