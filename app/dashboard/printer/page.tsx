  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-500">Configure your receipt printer and receipt format</p>
      </div>

      {/* Printer Status Card */}
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }}>
        <Card className={printerSettings.printerStatus === "connected" ? "border-green-200" : "border-red-200"}>
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div
                  className={`p-3 rounded-full ${
                    printerSettings.printerStatus === "connected" ? "bg-green-100" : "bg-red-100"
                  }`}
                >
                  <Printer
                    className={`h-6 w-6 ${
                      printerSettings.printerStatus === "connected" ? "text-green-600" : "text-red-600"
                    }`}
                  />
                </div>
                <div>
                  <h3 className="text-lg font-semibold">
                    {printerSettings.printerStatus === "connected" ? "Printer Connected" : "Printer Disconnected"}
                  </h3>
                  <p className="text-sm text-gray-500">{printerSettings.printerName}</p>
                </div>
              </div>
              ...
              <div className="flex gap-2">
                <Button
                  ...
                  onClick={() =>
                    setPrinterSettings({
                      ...printerSettings,
                      printerStatus: printerSettings.printerStatus === "connected" ? "disconnected" : "connected",
                    })
                  }
                >
                ...
                >
                  ...
                  {testPrintStatus === "success" && <Check className="w-4 h-4 mr-2" />}
                  {testPrintStatus === "error" && <AlertCircle className="w-4 h-4 mr-2" />}
      ...
      {printerSettings.printerStatus !== "connected" && (
        ...
        >
          <Alert variant="destructive">
            ...
            <AlertDescription>
              Your receipt printer is currently disconnected. Please check the connection and power status. Orders will
              still be processed, but receipts will need to be printed manually.
            </AlertDescription>
          </Alert>
        </motion.div>
      )}
      ...
      >
        <Card>
          ...
          <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="Star Micronics TSP143">Star Micronics TSP143</SelectItem>
            ...
            {/* Fallback Mode */}
            <div className="space-y-2">
              <Label htmlFor="fallbackMode">Fallback Mode (If printer is offline)</Label>
              <Select
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => setPrinterSettings({ ...printerSettings, printItemModifiers: checked })}
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => setPrinterSettings({ ...printerSettings, printCustomerNotes: checked })}
                />
              </div>
            </div>
          ...
          <CardContent>
            <div className="bg-white border border-gray-200 p-4 rounded-md font-mono text-sm max-w-xs mx-auto">
              <div className="text-center mb-4">
                ...
                <div className="text-xs text-gray-500">123 Main Street, Zurich</div>
                <div className="text-xs text-gray-500">Tel: +41 44 123 4567</div>
              </div>
              ...
              <div className="my-4">
                ...
                {printerSettings.printItemModifiers && <div className="text-xs text-gray-500 ml-4">- Extra cheese</div>}
