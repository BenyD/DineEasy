      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center p-4 sm:p-8 md:p-12 lg:p-16">
        ...
        >
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-500">Start your 14-day free trial and transform your restaurant operations</p>
          </div>
      ...
      <div className="hidden md:block md:w-1/2 bg-green-50 relative overflow-hidden">
        ...
        <div className="relative h-full flex flex-col items-center justify-center p-12">
          ...
          >
            ...
            <h2 className="text-2xl font-bold text-gray-800 mb-4">Transform Your Restaurant Operations</h2>
            <p className="text-gray-600 mb-6">
              Join over 1,000 restaurants using DineEasy to streamline ordering, increase efficiency, and delight
              customers with QR-based digital menus.
            </p>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm">Only 2% commission</span>
              </div>
            </div>
          </motion.div>
        </div>
