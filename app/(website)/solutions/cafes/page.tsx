...
const features = [
  ...
  },
  {
    ...
    title: "Digital Menu",
    description:
      "Showcase your coffee, pastries, and specials with an easy-to-update digital menu.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Monitor orders, track sales, and manage your cafe operations from a single dashboard.",
  },
  {
  ...
  return (
    <PageWrapper>
      <HeaderSection
        ...
        subtitle="Transform your cafe operations with our QR code ordering system."
      />
      ...
      <AnimatedSection className="py-16 sm:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
            ...
            >
              ...
              <p className="text-gray-600 mb-8">
                DineEasy helps cafes streamline operations with QR code-based
                ordering. Let your customers browse the menu, place orders, and
                pay directly from their phones while you focus on crafting the
                perfect cup.
              </p>
          ...
          <CTASection
            title="Ready to Modernize Your Cafe?"
            subtitle="Join cafes worldwide using DineEasy's QR ordering system"
            buttonText="See Demo"
