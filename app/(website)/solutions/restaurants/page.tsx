...
const features = [
  {
    ...
    description:
      "Generate unique QR codes for each table, enabling customers to order directly from their phones.",
  },
  {
    icon: <Smartphone className="h-8 w-8" />,
    title: "Digital Menu",
    description:
      "Create and update your digital menu instantly, with rich descriptions and images for each dish.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Monitor orders, track sales, and manage your restaurant operations from a single dashboard.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Track order patterns, popular items, and revenue with easy-to-understand analytics.",
  },
];
  ...
  return (
    <PageWrapper>
      <HeaderSection
        ...
        subtitle="Transform your restaurant operations with our QR code ordering system."
      />
      ...
      <AnimatedSection className="py-16 sm:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
            ...
            >
              ...
              <p className="text-gray-600 mb-8">
                DineEasy simplifies restaurant operations with QR code-based
                ordering. Let your customers browse the menu, place orders, and
                pay directly from their phones while you manage everything from
            ...
            >
              <div className="aspect-video rounded-xl overflow-hidden shadow-xl">
                <img
                  src="/images/restaurant-dashboard.jpg"
          ...
          <CTASection
            ...
            subtitle="Join restaurants worldwide using DineEasy's QR ordering system"
            buttonText="See Demo"
