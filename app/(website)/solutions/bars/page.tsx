...
const features = [
  {
    ...
    description:
      "Generate unique QR codes for each table, enabling customers to order drinks directly from their phones.",
  },
  {
    icon: <Smartphone className="h-8 w-8" />,
    title: "Digital Menu",
    description:
      "Showcase your drinks menu with high-quality images and detailed descriptions, easily updateable in real-time.",
  },
  {
    icon: <Receipt className="h-8 w-8" />,
    title: "Order Management",
    description:
      "Receive and manage drink orders in real-time through an intuitive dashboard interface.",
  },
  {
    icon: <LayoutDashboard className="h-8 w-8" />,
    title: "Bar Dashboard",
    description:
      "Monitor orders, track sales, and manage your bar operations from a single dashboard.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Track popular drinks, peak hours, and revenue with easy-to-understand analytics.",
  },
];
  ...
  return (
    <PageWrapper>
      <HeaderSection
        ...
        subtitle="Transform your bar operations with our QR code ordering system."
      />
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
            <motion.div
              ...
              transition={{ duration: 0.5 }}
            >
              <h2 className="text-3xl font-bold mb-6">Modern Bar Experience</h2>
              <p className="text-gray-600 mb-8">
                DineEasy helps bars streamline operations with QR code-based
                ordering. Let your customers browse the menu, place drink
                orders, and pay directly from their phones while you focus on
                crafting the perfect cocktails.
              </p>
          ...
          <CTASection
            title="Ready to Modernize Your Bar?"
            subtitle="Join bars worldwide using DineEasy's QR ordering system"
            buttonText="See Demo"
