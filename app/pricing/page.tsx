    ...
    <PageWrapper>
        ...
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            {plans.map((plan, index) => (
              <motion.div
                ...
                className={`relative rounded-xl border bg-white p-6 shadow-xs transition-all hover:shadow-lg sm:p-8 ${
                  plan.highlighted
                    ? "border-green-200 ring-1 ring-green-500 shadow-md"
                    : ""
                }`}
              >
                {plan.highlighted && (
                ...
                <div className="mb-6">
                  ...
                  <p className="mt-2 text-sm text-gray-500">
                    ...
                    {plan.name === "Pro" &&
                      "Ideal for growing restaurants with analytics needs"}
                    {plan.name === "Elite" &&
                      "For established restaurants with multiple staff"}
                  </p>
                </div>
                <div className="mb-6">
          ...
          <AnimatedSection delay={0.3}>
            <div className="mt-8 text-center text-sm text-gray-500 sm:mt-12">
              All plans include a 14-day free trial. Only 2% commission on
              Stripe & TWINT payments. Cancel anytime.
            </div>
          </AnimatedSection>
        </div>
      </AnimatedSection>
      ...
      <section className="bg-gray-50 py-16 sm:py-24">
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 mx-auto max-w-3xl sm:mt-16">
