-- Fix payment function signature to exactly match webhook calls
...
-- Create the function with the exact parameter order that the webhook is calling
...
-- Also fix the subscription upsert function to handle the subscription ID properly
