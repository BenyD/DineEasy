-- Update the generate_order_number function to handle conflicts better
  ...
  WHILE v_retry_count < v_max_retries LOOP
    IF pg_try_advisory_lock(v_lock_key) THEN
      ...
      BEGIN
        ...
        -- Ensure sequence doesn't exceed max
        IF v_sequence > v_max_sequence THEN
          v_sequence := 1;
        END IF;
